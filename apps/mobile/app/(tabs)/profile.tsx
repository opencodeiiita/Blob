  ...
  return (
    <View className="flex-1 justify-between bg-white dark:bg-black p-6">
      <View className="flex-1 items-center justify-center">
        <Text className="mb-3 text-center text-3xl font-bold text-purple-700 dark:text-purple-300">Profile</Text>
      ...
      <Pressable
        className="mb-5 items-center rounded-xl bg-purple-700 dark:bg-purple-600 px-8 py-4"
